...
export function MainLayout() {
  ...
  const focusedTaskView = location.pathname.startsWith('/folder-tasks')
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="relative flex flex-1 overflow-hidden">
        ...
        {!focusedTaskView && workbench && sidebarOpen && !compactRail && <div role="separator" aria-label="调整项目栏宽度" onPointerDown={startResize} className="relative z-40 w-px shrink-0 cursor-col-resize bg-border-light hover:bg-accent"><span className="absolute inset-y-0 -left-1 -right-1" /></div>}
